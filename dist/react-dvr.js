(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('stream'), require('prop-types'), require('react-dom')) :
	typeof define === 'function' && define.amd ? define(['react', 'stream', 'prop-types', 'react-dom'], factory) :
	(global.reactDvr = factory(global.React,global.stream,global.PropTypes,global.ReactDOM));
}(this, (function (React,stream,PropTypes,ReactDOM) { 'use strict';
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return React__default.createElement("form", {
      ...
      autoFocus: true
    }), error && React__default.createElement("div", null, error), React__default.createElement(Actions, null, React__default.createElement(SaveButton, null, "Save State"), React__default.createElement(CancelButton, {
      onClick: onCancel
    }, "Cancel")));
  };
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return React__default.createElement(Container, null, React__default.createElement(Title, null, "React DVR"), React__default.createElement(StatesContainer, null, React__default.createElement(StateRow, null, React__default.createElement(StateLabel, null, React__default.createElement("input", {
      type: "radio",
      checked: !activeState,
      ...
      var name = _ref2.name;
      return React__default.createElement(StateRow, {
        key: name,
        className: "rdvr-state-row"
      }, React__default.createElement(StateLabel, null, React__default.createElement("input", {
        type: "radio",
        checked: activeState === name,
        onChange: function onChange() {
          onSetActiveState(name);
        }
      }), " ", name, " "), React__default.createElement(Close, {
        onClick: function onClick() {
          onRemoveState(name);
        }
      }, "\xD7"));
    })), isAdding ? React__default.createElement(AddStateForm, {
      onSubmit: this.handleAddState,
      onCancel: this.handleClickCancelAdd
    }) : React__default.createElement(GhostedButton, {
    ...
    return (
      ...
      function (_React$Component) {
        ...
        function _class2() {
          ...
          return (_temp = _this = _React$Component.call.apply(_React$Component, [this].concat(args)) || this, _this.options = _extends$1({}, defaultOptions, options), _this.handleKeyUp = function (event) {
            ...
            return _extends$1({}, defaultState, localStorageState);
          }, _this.setLocalStorageState = function (updates) {
            var json = localStorage.getItem(_this.options.localStorageKey);
            var currentState = json ? JSON.parse(json) : {};
            var newState = typeof updates === "function" ? updates(currentState) : _extends$1({}, currentState, updates);
            ...
            ReactDOM.render(React__default.createElement(ReactDvrUi, {
              isShowing: showUI,
        ...
        _proto.render = function render() {
          ...
          return React__default.createElement(Target, _extends$1({}, this.props, propsOverride));
        };
